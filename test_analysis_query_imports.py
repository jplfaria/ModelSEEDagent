...
def test_analysis_imports():
    ...
    modelseedpy_lines = [i for i, line in enumerate(lines) if "modelseedpy 0.4.2" in line]
    ...
    analysis_lines = [i for i, line in enumerate(lines) if "AI analyzing your query" in line]
    ...
    if len(modelseedpy_lines) <= 1 and len(analysis_lines) <= 1:
        ...
        print(f"   This suggests the agent execution is still causing repeated module loads")
        return False
