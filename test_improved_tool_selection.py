...
def test_tool_selection():
    ...
    tools = [
        ...
        MinimalMediaTool({"name": "find_minimal_media", "description": "Find minimal media requirements"}),
        EssentialityAnalysisTool({"name": "analyze_essentiality", "description": "Analyze gene essentiality"}),
    ...
    for i, query in enumerate(test_queries, 1):
        ...
        try:
            ...
            analysis_tools = ["run_metabolic_fba", "find_minimal_media", "analyze_essentiality"]
    ...
    print("   Analysis queries should select analysis tools (FBA, minimal media, essentiality)")
