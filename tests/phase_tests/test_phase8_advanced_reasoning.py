...
class Phase8TestSuite:
    ...
    async def _test_reasoning_chains(self):
        ...
        try:
            ...
            assert (
                planned_chain.user_query
                == "Analyze E. coli model for growth optimization"
            )
            ...
            traceback.print_exc()
            self.test_results["reasoning_chains"] = {"status": "FAIL", "error": str(e)}
        ...
        try:
            ...
            self.test_results["hypothesis_system"] = {
                ...
                "hypotheses_generated": (
                    len(hypotheses) if "hypotheses" in locals() else 0
                ),
            ...
            traceback.print_exc()
            self.test_results["hypothesis_system"] = {"status": "FAIL", "error": str(e)}
            ...
            request = CollaborationRequest(
                ...
                options=[
                    {"name": "maximize_growth", "description": "Focus on growth rate"},
                    {
                        ...
                        "description": "Focus on metabolite production",
                    },
                    {
    ...
    async def _test_pattern_memory(self):
        ...
        try:
            ...
            extracted_patterns = await extractor.extract_patterns_from_experience(
                experience
            )
            ...
            traceback.print_exc()
            self.test_results["pattern_memory"] = {"status": "FAIL", "error": str(e)}
