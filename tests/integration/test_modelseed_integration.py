...
def test_tool_registration():
    ...
    try:
        ...
        print(
            f"  📊 {registered_count}/{len(modelseed_tools)} ModelSEED tools registered"
        )
...
def test_cli_integration():
    ...
    try:
        ...
        if set(expected_names) == set(actual_names):
            ...
            print(
                f"  ❌ Tool name mismatch: expected {expected_names}, got {actual_names}"
            )
            return False
...
def test_modelseedpy_availability():
    ...
    try:
        ...
        print(
            f"  📊 {len(available_components)}/{len(components)} key components available"
        )
...
def test_example_data():
    ...
    try:
        ...
        print(
            f"  📊 {len(available_files)}/{len(example_files)} example files available"
        )
...
def main():
    ...
    if passed_tests == total_tests:
        ...
        print(
            f"❌ {total_tests - passed_tests} tests failed. Please address issues before proceeding."
        )
        return False
