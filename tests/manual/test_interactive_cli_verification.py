...
def test_interactive_cli_verification():
    ...
    try:
        ...
        module_import_count = stdout.count("modelseedpy 0.4.2") + stdout.count(
            "cobrakbase 0.4.0"
        )
        ...
        has_critical_success = any(
            indicator in successes
            for indicator in ["Welcome to ModelSEEDagent", "AI analyzing your query"]
        )
