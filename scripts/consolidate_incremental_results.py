...
def consolidate_and_split_results():
    ...
    comprehensive_data = {"metadata": all_metadata, "results": consolidated_results}
    ...
    print(
        f"📊 Total tests: {total_tests}, Success rate: {100*all_metadata['success_rate']:.1f}%"
    )
