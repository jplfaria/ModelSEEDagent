...
def create_database_schema(conn):
    ...
    cursor.execute('CREATE INDEX IF NOT EXISTS idx_compound_aliases_external ON compound_aliases(external_id)')
    cursor.execute('CREATE INDEX IF NOT EXISTS idx_compound_aliases_source ON compound_aliases(source)')
    cursor.execute('CREATE INDEX IF NOT EXISTS idx_compound_names_name ON compound_names(name)')
    cursor.execute('CREATE INDEX IF NOT EXISTS idx_reaction_aliases_external ON reaction_aliases(external_id)')
    cursor.execute('CREATE INDEX IF NOT EXISTS idx_reaction_aliases_source ON reaction_aliases(source)')
...
def main():
    ...
    missing_files = []
    for file_path in [compound_names_file, compound_aliases_file, reaction_aliases_file]:
